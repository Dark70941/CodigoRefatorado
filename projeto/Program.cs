// ============================================================
//   SISTEMA DE BIBLIOTECA - VERSÃO REFACTORADA (SOLID COMPLIANT)
//   Todas as violações SOLID foram corrigidas.
//   Código limpo, extensível e testável.
// ============================================================
...
namespace Biblioteca
{
    ...
    // Livro agora tem apenas responsabilidade de dados.
    // Outras responsabilidades foram extraídas para classes específicas.
    // =============================================================
    public class Livro
    {
    ...
    // Responsabilidade de cálculo de multa
    ...
    // Responsabilidade de comunicação/envio de e-mail
    ...
    // Responsabilidade de geração de relatórios
    ...
    // Novos tipos de usuário podem ser adicionados sem modificar código existente.
    // =============================================================
    ...
    // Factory para estratégias de desconto
    ...
    // Separação clara entre itens físicos e digitais.
    // Cada tipo tem apenas as operações que fazem sentido para ele.
    // =============================================================
    ...
    // Interface específica para itens que suportam reserva física
    ...
    // Classes implementam apenas o que realmente precisam.
    // =============================================================
    ...
    // RelatorioEmprestimos implementa apenas o que precisa
    ...
    // RelatorioInventario implementa apenas o que precisa
    ...
    // GerenciadorAcervo depende de abstrações, não de classes concretas.
    // Dependências são injetadas via construtor (Inversão de Controle).
    // =============================================================
    ...
    // =============================================================
    //   PROGRAMA PRINCIPAL - DEMONSTRAÇÃO DO CÓDIGO REFACTORADO
    // =============================================================
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var item in itens)
            {
                ...
                // Apenas itens reserváveis podem ser reservados
